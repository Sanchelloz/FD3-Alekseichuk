...
class ItemBlock extends React.PureComponent {
    ...
    editItem = (EO) => {
        console.log("name edit="+this.props.name+"code edit="+this.props.code);
    ...
    deleteItem = (EO) => {
        console.log("code del="+this.props.code);
        this.props.cbDeletedItem(this.props.code);
        EO.stopPropagation();
    };

    render() {
        console.log("render item - "+ this.props.code);
        return (
